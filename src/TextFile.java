...
public class TextFile {
         ...
         * @param filename The name of the file to run from or write to
         ...
         * exception instead of halting the program on an error, but I'm
         * trying to make your code a little simplier)
         * This method will also halt execution if you try to run past the
         * end of a file.
        ...
        public char readChar()
        {
            ...
            try
            {
                Assert.notFalse(inputFile,"Can only run from input files!");
